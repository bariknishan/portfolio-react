    ...
    <div className="hero min-h-screen py-6 banner    ">
      <div className="hero-content flex-col lg:flex-row-reverse   banner">
        ...
        <div  className='para-area'>
          ...
          <p className="py-6 text-xl font-bold text-white"> Hi My name is Barik. I am a Frontend Developer.I design and develops beautiful websites with responsive elements. I create custom websites to help business do better. </p>
